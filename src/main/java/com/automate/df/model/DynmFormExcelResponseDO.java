...
import com.automate.df.error.DynamicFormFieldExcelError;
import com.automate.df.error.DynamicUploadExcelError;


public class DynmFormExcelResponseDO {
	...
	public DynmFormExcelResponseDO(String message, String status,List<DynamicUploadExcelError> dynamicFormFieldExcelErrors) {
		super();
