...
/**
 * The persistent class for the dms_contact database table.
 */
@Setter
@Getter
@Entity
...
public class DmsContact implements Serializable {
    ...
    public DmsAttachment addDmsAttachment(DmsAttachment dmsAttachment) {
        ...
        dmsAttachment.setDmsContact(this);
    ...
    public DmsAttachment removeDmsAttachment(DmsAttachment dmsAttachment) {
        ...
        dmsAttachment.setDmsContact(null);
