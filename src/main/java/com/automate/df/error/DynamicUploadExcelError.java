...
public class DynamicUploadExcelError {
	...
	public DynamicUploadExcelError(){ }
	
	public DynamicUploadExcelError(DynamicFormErrorCode errorCode, String errorMessage,List<String> errorFields,String recordLineNumber){
